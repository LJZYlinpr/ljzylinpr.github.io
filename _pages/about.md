...
<div class="home-shell">
  <section class="home-hero">
    <aside class="profile-panel section-card">
      ...
      <ul class="profile-panel__meta">
        ...
        <li><a href="mailto:linpeiran@westlake.edu.cn">linpeiran@westlake.edu.cn</a></li>
      </ul>
      <div class="profile-panel__links">
        <a class="home-button" href="https://scholar.google.com/citations?user=5XTeZSAAAAAJ&hl=zh-CN">Google Scholar</a>
        <a class="home-button" href="https://github.com/LJZYlinpr">GitHub</a>
        <a class="home-button" href="https://www.researchgate.net/profile/Peiran-Lin-2?ev=hdr_xprf&_tp=eyJjb250ZXh0Ijp7ImZpcnN0UGFnZSI6ImhvbWUiLCJwYWdlIjoiaG9tZSIsInBvc2l0aW9uIjoiZ2xvYmFsSGVhZGVyIn19">ResearchGate</a>
      </div>
    </aside>
    ...
    <div class="hero-copy section-card">
      ...
      <p class="hero-lead">
        I am a PhD student in Biology at Westlake University. My research sits at the intersection of computational biology,
        virtual-cell modeling, gene regulatory networks, and spatial multi-omics, with the goal of building interpretable AI systems for biological discovery.
      </p>
      <div class="hero-labs">
    ...
    <aside class="hero-rail">
      <div class="hero-panel__card section-card">
        ...
        <ul class="snapshot-list">
          ...
          <li><strong>Direction</strong><span>AI for life science, virtual cells, and cellular systems modeling</span></li>
      ...
      <div class="hero-panel__card section-card">
        ...
        <div class="mini-news-list">
          <article class="mini-news-item">
            ...
            <p>Contributed to a Westlake project submitted to <em>Nature Neuroscience</em>.</p>
          </article>
          <article class="mini-news-item">
  ...
  <section class="home-metrics">
    <div class="metric-card">
      <span class="metric-card__value">6 + 4</span>
      <span class="metric-card__label">Six published papers and four submitted or ongoing works in progress</span>
    </div>
    <div class="metric-card">
      <span class="metric-card__value">2</span>
      <span class="metric-card__label">Undergraduate majors in Life Sciences and Computer Science & Technology</span>
    </div>
    <div class="metric-card">
      <span class="metric-card__value">GRN</span>
      <span class="metric-card__label">Interested in virtual cells, gene regulation, and interpretable biological AI</span>
    </div>
    <div class="metric-card">
  ...
  <section class="home-grid home-grid--two">
    <div class="section-card">
      ...
      <p>
        ...
        I am especially motivated by problems where AI can help build mechanistic and testable models for living systems.
      </p>
      <div class="edu-grid">
    ...
    <div class="section-card">
      ...
      <p class="section-note">
        I am interested in turning complex biological measurements into interpretable models that support discovery, perturbation analysis, and hypothesis generation.
      </p>
    </div>
  </section>
  ...
  <section class="section-card section-card--wide">
    ...
    <div class="timeline">
      ...
      <div class="timeline-item">
        ...
        <p>Started a lab rotation in Prof. Hongtao Yu's group.</p>
      </div>
      <div class="timeline-item">
        <span class="timeline-item__date">2025.08.22-24</span>
        <p>Attended The First International Conference on AI & Biotechnology at Harbin Institute of Technology.</p>
      </div>
      <div class="timeline-item">
        <span class="timeline-item__date">2025.08.22</span>
        <p>Officially began my PhD journey at Westlake University.</p>
      </div>
      <div class="timeline-item">
        <span class="timeline-item__date">2025.07.21-24</span>
        <p>Participated in QBio 2025: Emergent Orders in Living Systems Across Scales at Peking University.</p>
      </div>
      <div class="timeline-item">
        <span class="timeline-item__date">2025.06.30</span>
        <p>Graduated from Shandong University.</p>
      </div>
      <div class="timeline-item">
